...
//! implementation.  All angular quantities use [`qtty::Radians`]; distances
//! use [`qtty::Kilometers`].
//!
//! ## Sources
//!
...
pub const A0: Kilometers = Kilometers::new(384_747.980_644_895_4);
...
pub const ATH: Kilometers = Kilometers::new(384_747.980_674_316_5);
...
pub const PRECES: Radians = Radians::new(0.024_381_748_353_014_515);
...
pub const DELNU: Radians = Radians::new(3.209_356_158_623_529e-10);
/// Correction to the Moon's eccentricity Δe.
pub const DELE: Radians = Radians::new(8.673_316_755_049_599e-8);
/// Correction to the Earth's eccentricity γ Δγ.
pub const DELG: Radians = Radians::new(-3.910_507_151_829_518e-7);
/// Correction to the precession in longitude Δn'.
pub const DELNP: Radians = Radians::new(-3.707_809_503_452_549e-11);
/// Correction to the obliquity Δε.
pub const DELEP: Radians = Radians::new(-6.243_915_399_009_714e-7);
...
#[allow(clippy::all)]
pub const DEL: [[Radians; 5]; 4] = [
    [
        Radians::new(5.198_466_741_027_443),
        Radians::new(7_771.377_146_811_758_394),
        Radians::new(-2.844_935_162_1e-5),
        Radians::new(3.197_346_2e-8),
        Radians::new(-1.543_65e-10),
    ],
    [
        Radians::new(-0.043_125_180_208_125),
        Radians::new(628.301_955_168_488_007),
        Radians::new(-2.680_534_843_0e-6),
        Radians::new(7.126_76e-10),
        Radians::new(7.270_0e-13),
    ],
    [
        Radians::new(2.355_555_898_265_799),
        Radians::new(8_328.691_426_955_554_562),
        Radians::new(1.570_277_576_16e-4),
        Radians::new(2.504_111_14e-7),
        Radians::new(-1.186_339e-9),
    ],
    [
        Radians::new(1.627_905_233_371_468),
        Radians::new(8_433.466_158_130_539_043),
        Radians::new(-5.939_210_000_4e-5),
        Radians::new(-4.949_948e-9),
        Radians::new(2.021_7e-11),
    ],
];
...
pub const ZETA: [Radians; 2] = [
    Radians::new(3.810_344_430_588_308), // (218° 18′ 59.95571″) in rad
    Radians::new(8_399.709_113_522_269), // 1 732 559 343.736 04″ + PRECES, in rad/millennium
];
...
#[allow(clippy::all)]
pub const P_ARGS: [[Radians; 2]; 8] = [
    [Radians::new(4.402_608_842_402_962), Radians::new(2_608.790_314_157_411)],
    [Radians::new(3.176_146_696_907_594), Radians::new(1_021.328_554_621_109)],
    [Radians::new(1.753_470_343_150_658), Radians::new(628.307_584_962_155)],
    [Radians::new(6.203_480_913_399_945), Radians::new(334.061_243_149_230)],
    [Radians::new(0.599_546_497_388_674), Radians::new(52.969_096_509_472)],
    [Radians::new(0.874_016_756_518_481), Radians::new(21.329_909_543_800)],
    [Radians::new(5.481_293_871_604_991), Radians::new(7.478_159_856_714)],
    [Radians::new(5.311_886_286_783_467), Radians::new(3.813_303_563_758)],
];
...
pub const W1: [Radians; 5] = [
    Radians::new(3.810_344_430_588_308),      // epoch offset (218° 18′ 59.95571″)
    Radians::new(8_399.684_731_773_916),      // rate: 1 732 559 343.736 04″ in rad/millennium
    Radians::new(-2.854_728_398_477_281e-5),  // T² coefficient
    Radians::new(3.201_709_550_047_375e-8),   // T³ coefficient
    Radians::new(-1.536_374_555_436_120e-10), // T⁴ coefficient
];
